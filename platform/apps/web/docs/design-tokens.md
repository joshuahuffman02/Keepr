...
```tsx
<button className="bg-emerald-600 text-white hover:bg-emerald-700">New Reservation</button>
```
...
```tsx
<span className="bg-amber-100 text-amber-800 border-amber-200">{count} open</span>
```
