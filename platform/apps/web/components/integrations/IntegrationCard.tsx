    ...
    >
      <Card
        className={cn(
          ...
          hasError && "ring-2 ring-red-500/20 border-red-200",
              ...
              className={cn(
                ...
                isConnected
                  ...
                  : hasError
                    ...
                    : "bg-muted text-muted-foreground group-hover:bg-status-info/15 group-hover:text-status-info",
              )}
            >
        ...
        <CardContent className="pt-0 space-y-4">
          ...
          <div className="pt-2">
            {isComingSoon ? (
              ...
              <Button
                className={cn("w-full group/btn transition-all", "bg-muted hover:bg-muted", "")}
                onClick={onConnect}
              >
