...
import { Tent, Sparkles, MapPin, Calendar, User, PartyPopper } from "lucide-react";
          ...
          <div className="flex flex-col items-center py-6 space-y-5">
            ...
            >
              ...
              <motion.div
                ...
                initial={
                  prefersReducedMotion ? {} : { boxShadow: "0 0 0 0 rgba(16, 185, 129, 0.4)" }
                }
                animate={
                  prefersReducedMotion ? {} : { boxShadow: "0 0 0 20px rgba(16, 185, 129, 0)" }
                }
            ...
            >
              <h2 className="text-2xl font-bold text-foreground">Welcome to Camp!</h2>
            ...
            >
              <div className="rounded-xl border border-status-success/30 bg-status-success/10 p-4 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-status-success font-medium">Guest</div>
                    <div className="text-lg font-bold text-foreground">{guestName}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-status-success font-medium">Assigned Site</div>
                    <div className="text-lg font-bold text-foreground">{siteName}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-status-success font-medium">Stay Dates</div>
