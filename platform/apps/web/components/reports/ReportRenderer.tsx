...
import {
    // Daily
    ShiftNotesReport, MealCountReport, ParkingListReport, PetListReport,
    OutOfOrderReport, CompStaysReport, VipArrivalsReport, DailyRateCheckReport,
    // Revenue
    RevenueOverviewReport, RevenueByRatePlanReport, RevenueByAddonReport, RevenueByUserReport,
    DiscountUsageReport, RefundsAdjustmentsReport, TaxCollectionReport, CashDrawerReport,
    VoidedTransactionsReport, MonthlyRecapReport, RevparSiteTypeReport, AncillaryRevenueReport,
    // Performance
    PaceReport, SiteBreakdownReport, OccupancyDayWeekReport, LeadTimeReport,
    ChannelProductionReport, CompSetReport, YoyPerformanceReport, MarketSegmentsReport,
    SiteUtilizationReport, YieldManagementReport, PromotionPerfReport, UpsellConversionReport,
    // Accounting
    AgingReport, CityLedgerReport, GuestLedgerReport, DepositLedgerReport,
    TrialBalanceReport, TaxExemptReport, ReconciliationReport, BankDepositReport,
    ArDetailReport, WriteOffsReport, LiabilitiesReport,
    // Marketing
    BookingSourcesReport, CampaignsReport, ReferralsReport, PromoCodesReport,
    EmailRoiReport, WebsiteConversionReport, SocialAttributionReport, GeoTargetingReport,
    OtaCommissionsReport, CartAbandonmentReport,
    // Forecasting
    RevenueForecastReport, DemandOutlookReport, PickupReport, PeakNonpeakReport,
    Outlook30Report, Outlook60Report, Outlook90Report, YearEndProjReport,
    BudgetVsActualReport, DemandAlertsReport,
    // Audits
