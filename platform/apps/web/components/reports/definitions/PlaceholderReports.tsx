...
export function DataNotAvailableReport({ reportName, description, requiredData }: DataNotAvailableReportProps) {
    return (
...
export function GuestFeedbackReport({ campgroundId, dateRange }: { campgroundId: string; dateRange: { start: string; end: string } }) {
    return (
...
export function GuestPreferencesReport({ campgroundId, dateRange }: { campgroundId: string; dateRange: { start: string; end: string } }) {
    return (
        <DataNotAvailableReport
            campgroundId={campgroundId}
            dateRange={dateRange}
...
export function BannedListReport({ campgroundId, dateRange }: { campgroundId: string; dateRange: { start: string; end: string } }) {
    return (
        <DataNotAvailableReport
            campgroundId={campgroundId}
            dateRange={dateRange}
...
export function SpecialDatesReport({ campgroundId, dateRange }: { campgroundId: string; dateRange: { start: string; end: string } }) {
    return (
        <DataNotAvailableReport
            campgroundId={campgroundId}
            dateRange={dateRange}
...
export function LoyaltyMembershipReport({ campgroundId, dateRange }: { campgroundId: string; dateRange: { start: string; end: string } }) {
    return (
        <DataNotAvailableReport
            campgroundId={campgroundId}
            dateRange={dateRange}
