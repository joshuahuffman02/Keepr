                ...
                reportData.map((e) => (
                  <tr key={e.id} className="hover:bg-muted">
                    ...
                    <td className="px-4 py-3">
                      <Badge
                        variant={e.direction === "credit" ? "default" : "secondary"}
                        className={
                          e.direction === "credit"
                    ...
                    <td className="px-4 py-3 text-muted-foreground text-xs">{e.glCode || "—"}</td>
                    <td
                      className={`px-4 py-3 text-right font-mono ${e.direction === "credit" ? "text-emerald-700" : "text-foreground"}`}
                    >
