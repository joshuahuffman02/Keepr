      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Guests arriving before standard check-in time
          </p>
        </CardHeader>
        <CardContent>
          {reportData.length === 0 ? (
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Guests departing after standard check-out time
          </p>
        </CardHeader>
        <CardContent>
          {reportData.length === 0 ? (
          ...
          {reportData.length === 0 ? (
            ...
            <div className="space-y-2">
              {reportData.map((r) => (
                <div
                  key={r.id}
                  className="flex justify-between items-center p-3 bg-card rounded-lg border border-amber-200"
                >
                  <div>
                    <div className="font-medium">
                      {r.guest?.primaryFirstName} {r.guest?.primaryLastName}
