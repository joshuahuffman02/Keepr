...
export function AdminTopBar({
  ...
  const displayEmail =
    isAuthenticated && userName && userEmail && userEmail !== userName ? userEmail : "";
            ...
            {isMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-56 bg-popover rounded-xl shadow-xl border border-border py-2 z-50">
                ...
                >
                  ...
                  Keyboard Shortcuts
                  <kbd className="ml-auto px-1.5 py-0.5 bg-muted rounded text-[10px] text-muted-foreground/70 border border-border">
                    ?
                  </kbd>
                </button>
                ...
                >
                  ...
                  What's New
                  <span className="ml-auto px-1.5 py-0.5 bg-status-warning/15 rounded text-[10px] text-status-warning font-medium">
                    NEW
                  </span>
                </Link>
