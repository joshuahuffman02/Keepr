...
function parseNewbookCsvLocally(csvContent: string): ImportPreview {
    ...
    if (lines.length < 2) return { rows: [], siteClasses: new Set(), sites: new Set(), guests: new Set(), warnings: ["No data rows found"] };
        ...
        <Card className="p-6 space-y-4">
            ...
            {!preview ? (
                ...
                <div className="space-y-4">
                    ...
                    {/* Import result */}
                    {importResult && (
                        <div className={`rounded-lg p-4 flex items-start gap-3 ${importResult.success ? "bg-emerald-50" : "bg-red-50"
                            }`}>
