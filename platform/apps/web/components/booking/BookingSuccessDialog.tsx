        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center py-4 space-y-5">
            ...
            <motion.div
              className="relative"
              initial={
                prefersReducedMotion ? { opacity: 0 } : { opacity: 0, scale: 0.5, rotate: -180 }
              }
            ...
            >
              ...
              <motion.div
                ...
                animate={
                  prefersReducedMotion ? {} : { boxShadow: "0 0 0 16px rgba(16, 185, 129, 0)" }
                }
            ...
            >
              ...
              {daysUntilArrival > 0 && (
                ...
                >
                  ...
                  {daysUntilArrival === 1
                    ? "Tomorrow!"
                    : `${daysUntilArrival} days until your adventure`}
                </motion.p>
              )}
            </motion.div>
            ...
            >
              ...
              <Button onClick={handleDone} className="bg-emerald-600 hover:bg-emerald-700">
                View Reservation
