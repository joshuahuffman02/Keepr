            ...
            <div className="relative z-30">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center bg-card rounded-2xl shadow-2xl shadow-slate-900/10 border border-border/50 overflow-hidden p-3 sm:p-0">
                    ...
                    <div className="pl-1 sm:pl-5 pr-2 sm:pr-3 self-start sm:self-center">
                        <svg className="w-5 h-5 text-muted-foreground" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Expanded filters */}
                {isExpanded && (
                    <div className="absolute top-full left-0 right-0 mt-3 p-6 bg-card rounded-2xl shadow-2xl shadow-slate-900/10 border border-border/50 z-50">
