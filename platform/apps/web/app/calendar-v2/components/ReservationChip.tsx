  ...
  return (
    <div
      className={cn(
        ...
        statusClass,
        isCompact
          ? "top-1 bottom-1 left-1 right-1 px-2"
          : "top-1.5 bottom-1.5 left-1.5 right-1.5 px-2.5",
    ...
    >
      <div className="flex items-center gap-2 min-w-0 w-full">
        <div
          className={cn(
            "flex min-w-0",
            isExpanded ? "flex-col gap-0.5" : isCompact ? "flex-row items-center" : "flex-col",
          )}
        >
          ...
          {densityConfig.showDetails && (
            <span
              className={cn(
                "opacity-80 truncate uppercase tracking-wider",
