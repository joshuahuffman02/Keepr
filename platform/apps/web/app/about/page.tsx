            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <h3 className="font-bold text-slate-900 mb-2">Adventure First</h3>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <h3 className="font-bold text-slate-900 mb-2">Sustainability</h3>
                        <p className="text-sm text-slate-600">
                ...
                <div className="text-center bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="/"
                            className="px-6 py-3 bg-white text-emerald-600 font-semibold rounded-lg hover:bg-slate-100 transition-colors"
                        >
                            Find Campgrounds
                        </a>
                        <a
