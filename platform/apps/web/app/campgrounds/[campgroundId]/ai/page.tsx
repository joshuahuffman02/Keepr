        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Configure AI features for {campground?.name || "this campground"}
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-amber-900">
                    Enable AI to unlock intelligent features
                  </h3>
                  <p className="text-sm text-amber-700 mt-1">
                    AI helps your staff respond faster, provides booking assistance to guests, and
                    surfaces insights from your data. All data is anonymized before AI processing.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Controls how much data is stripped before AI sees it
                  </p>
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`p-3 rounded-lg border text-left transition-all ${
                          settings.aiAnonymizationLevel === option.value
                ...
                <div className="p-3 rounded-lg bg-muted text-sm text-muted-foreground">
                  <strong>AI powered by Keepr.</strong> We use OpenAI's GPT-4 to provide AI
                  features. Your data is anonymized before processing and never used to train
                  models.
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        AI-generated reply suggestions for staff
                      </div>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Help guests find the right site
                      </div>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Predict occupancy and optimize pricing
                      </div>
                    </div>
                  </div>
                  <Switch
