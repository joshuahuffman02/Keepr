...
export default function SitesPage() {
  ...
  const mapFormToPayload = (state: SiteFormState, opts?: { clearEmptyAsNull?: boolean }) => {
    ...
    const siteClassId = state.siteClassId
      ? state.siteClassId
  ...
  const filteredSites = useMemo(() => {
    ...
    const filtered = data.filter((site) => {
      ...
      // Class filter
      if (filterClass && filterClass !== "__all__" && site.siteClassId !== filterClass)
        return false;
      // Active filter
    ...
    const sorted = [...filtered].sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case "siteNumber":
          ...
          comparison = a.siteNumber.localeCompare(b.siteNumber, undefined, {
            numeric: true,
            sensitivity: "base",
          });
          break;
  ...
  const quickUpdateSite = useMutation({
    mutationFn: (payload: {
      id: string;
      data: Partial<ReturnType<typeof mapFormToPayload>>;
      previousData?: Partial<ReturnType<typeof mapFormToPayload>>;
      description?: string;
          ...
          action: (
            <ToastAction
              ...
              onClick={() => {
                ...
                queryClient.setQueryData<Site[]>(["sites", campgroundId], (old) => {
                  if (!old) return old;
                  return old.map((site) => (site.id === id ? { ...site, ...previousData } : site));
                });
  ...
  const createSite = useMutation({
    mutationFn: () => apiClient.createSite(campgroundId, mapFormToPayload(formState)),
    onSuccess: () => {
  ...
  const updateSite = useMutation({
    mutationFn: (payload: { id: string; data: ReturnType<typeof mapFormToPayload> }) =>
      apiClient.updateSite(payload.id, payload.data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["sites", campgroundId] });
      setEditingId(null);
  ...
  const sitesWithHookups =
    data?.filter((s) => s.hookupsPower || s.hookupsWater || s.hookupsSewer).length || 0;
      ...
      >
          ...
          >
            ...
            <Select value={filterClass} onValueChange={setFilterClass}>
              <SelectTrigger
                ...
                aria-label="Filter by site class"
              >
        ...
        <AnimatePresence>
          {selectedSites.size > 0 && (
            ...
            >
              ...
              >
                <SelectTrigger
                  className="w-[150px] bg-background border-emerald-300"
                  aria-label="Change class for selected sites"
                >
              ...
              <Button size="sm" variant="ghost" onClick={() => setSelectedSites(new Set())}>
                Clear selection
              </Button>
              {bulkUpdateSites.isPending && (
                      ...
                      {showAdvanced && (
                        ...
                        >
                          <Input
                            ...
                            onChange={(e) =>
                              setFormState((s) => ({ ...s, maxOccupancy: Number(e.target.value) }))
                            }
                            className="bg-background border-border"
                          ...
                          <div className="flex flex-wrap gap-3 md:col-span-2">
                            ...
                            <label className="flex items-center gap-2 text-sm text-foreground">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  setFormState((s) => ({ ...s, hookupsPower: Boolean(checked) }))
                                }
                            ...
                            <label className="flex items-center gap-2 text-sm text-foreground">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  setFormState((s) => ({ ...s, hookupsWater: Boolean(checked) }))
                                }
                            ...
                            <label className="flex items-center gap-2 text-sm text-foreground">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  setFormState((s) => ({ ...s, hookupsSewer: Boolean(checked) }))
                                }
                          ...
                          <div className="flex flex-wrap gap-3 md:col-span-2">
                            ...
                            <label className="flex items-center gap-2 text-sm text-foreground">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  setFormState((s) => ({ ...s, petFriendly: Boolean(checked) }))
                                }
                            ...
                            <label className="flex items-center gap-2 text-sm text-foreground">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  setFormState((s) => ({ ...s, accessible: Boolean(checked) }))
                                }
                          ...
                          <div className="md:col-span-2 space-y-1">
                            ...
                            <div className="bg-muted p-2 rounded-lg border border-border mb-2">
                              <ImageUpload
                                onChange={(url) => {
                                  if (!url) return;
                                  const current = formState.photos
                                    ? formState.photos
                                        .split(",")
                                        .map((p) => p.trim())
                                        .filter(Boolean)
                            ...
                            <Textarea
                              ...
                              onChange={(e) =>
                                setFormState((s) => ({ ...s, photos: e.target.value }))
                              }
        ...
        {paginatedSites.length > 0 && (
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Checkbox
              checked={
                paginatedSites.length > 0 && paginatedSites.every((s) => selectedSites.has(s.id))
              }
            ...
            <Table>
              ...
              <TableBody>
                {paginatedSites.map((site, index) => {
                  ...
                  const isInheritedHookups =
                    !siteHasOwnHookups &&
                    cls &&
                    (cls.hookupsPower || cls.hookupsWater || cls.hookupsSewer);
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex flex-col">
                            <button
                              onClick={() =>
                                router.push(`/campgrounds/${campgroundId}/sites/${site.id}`)
                              }
                        ...
                        <TableCell className="hidden sm:table-cell">
                          {siteTypeConfig[site.siteType] ? (
                            <Badge
                              variant="secondary"
                              className={cn("gap-1", siteTypeConfig[site.siteType].color)}
                            >
                        ...
                        <TableCell>
                          <Select
                            ...
                            onValueChange={(value) => {
                              ...
                              const newClassName =
                                classesQuery.data?.find((c) => c.id === newClassId)?.name ||
                                "No class";
                              ...
                              <>
                                {effectivePower && (
                                  ...
                                  >
                                    ...
                                    {(() => {
                                      const amps =
                                        site.powerAmps && site.powerAmps.length > 0
                                          ? site.powerAmps
                                          : (cls?.electricAmps ?? []);
                                      return amps.length > 0 ? (
                                        <span className="text-xs">{amps.join("/")}A</span>
                                      ) : null;
                                    })()}
                                  </span>
                                )}
                        ...
                        <TableCell>
                          <button
                            ...
                            disabled={quickUpdateSite.isPending}
                            title={
                              site.isActive !== false ? "Click to deactivate" : "Click to activate"
                            }
                              ...
                              onClick={() => {
                                ...
                                if (!isEditing) {
                                  ...
                                  setEditForm({
                                    ...
                                    powerAmps: Array.isArray(site.powerAmps)
                                      ? site.powerAmps
                                      : site.powerAmps
                                        ? [site.powerAmps]
                                        : (cls?.electricAmps ?? []),
                            ...
                            >
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setEditForm((s) =>
                                      s ? { ...s, siteNumber: e.target.value } : s,
                                    )
                                  }
                                  className="bg-background border-border"
                                  aria-label="Site number"
                                      ...
                                      setEditForm((s) =>
                                        s
                                          ? {
                                              ...
                                              siteType: selectedClass.siteType || s.siteType,
                                              maxOccupancy:
                                                selectedClass.maxOccupancy || s.maxOccupancy,
                                              rigMaxLength:
                                                selectedClass.rigMaxLength ?? s.rigMaxLength,
                                              hookupsPower:
                                                selectedClass.hookupsPower ?? s.hookupsPower,
                                              hookupsWater:
                                                selectedClass.hookupsWater ?? s.hookupsWater,
                                              hookupsSewer:
                                                selectedClass.hookupsSewer ?? s.hookupsSewer,
                                              petFriendly:
                                                selectedClass.petFriendly ?? s.petFriendly,
                                              accessible: selectedClass.accessible ?? s.accessible,
                                              minNights: selectedClass.minNights ?? s.minNights,
                                              maxNights: selectedClass.maxNights ?? s.maxNights,
                                            }
                              ...
                              <div className="flex flex-wrap items-center gap-4">
                                ...
                                <label className="flex items-center gap-2 text-sm text-foreground">
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                      setEditForm((s) =>
                                        s ? { ...s, hookupsPower: Boolean(checked) } : s,
                                      )
                                    }
                                    aria-label="Power hookups"
                                  />
                                ...
                                <label className="flex items-center gap-2 text-sm text-foreground">
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                      setEditForm((s) =>
                                        s ? { ...s, hookupsWater: Boolean(checked) } : s,
                                      )
                                    }
                                    aria-label="Water hookups"
                                  />
                                ...
                                <label className="flex items-center gap-2 text-sm text-foreground">
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                      setEditForm((s) =>
                                        s ? { ...s, hookupsSewer: Boolean(checked) } : s,
                                      )
                                    }
                                    aria-label="Sewer hookups"
                                  />
                                ...
                                <span className="text-xs font-semibold text-muted-foreground ml-4">
                                  Features:
                                </span>
                                <label className="flex items-center gap-2 text-sm text-foreground">
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                      setEditForm((s) =>
                                        s ? { ...s, petFriendly: Boolean(checked) } : s,
                                      )
                                    }
                                    aria-label="Pet friendly"
                                  />
                                ...
                                <label className="flex items-center gap-2 text-sm text-foreground">
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                      setEditForm((s) =>
                                        s ? { ...s, accessible: Boolean(checked) } : s,
                                      )
                                    }
                                    aria-label="Accessible"
                                  />
        ...
        {filteredSites.length > itemsPerPage && (
          ...
          >
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              >
                <SelectTrigger
                  className="w-[70px] h-8 bg-background border-border"
            ...
            <div className="text-sm text-muted-foreground">
              ...
              {Math.min(currentPage * itemsPerPage, filteredSites.length)} of {filteredSites.length}
            </div>
          </motion.div>
        )}
      </motion.div>
