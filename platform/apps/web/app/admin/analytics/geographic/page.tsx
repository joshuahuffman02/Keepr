...
export default function GeographicPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-bold text-foreground">Geographic Intelligence</h1>
            {isUsingMockData && (
      ...
      <Card className="border-border">
        <CardHeader>
          <CardTitle className="text-lg text-foreground">Distance vs Spend Insight</CardTitle>
        </CardHeader>
        <CardContent>
