        ...
        <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12 prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Keepr (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              As part of our early access program, we collect additional information to improve
              Keepr:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>
                <strong>Usage Analytics:</strong> How you navigate and use features, to identify
                improvements
              </li>
              <li>
                <strong>Feature Feedback:</strong> Your suggestions and reported issues, linked to
                your account for context
              </li>
              <li>
                <strong>Performance Data:</strong> System metrics to optimize speed and reliability
              </li>
            </ul>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-muted/50 rounded-lg">
              <p className="text-foreground">
                <strong>Email:</strong> privacy@keeprstay.com
                <br />
