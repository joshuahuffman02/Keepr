...
import { MapPin, Calendar, Wifi, CloudSun, Navigation, ArrowRight, ExternalLink } from "lucide-react";
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="animate-pulse text-emerald-600 font-medium">Loading your welcome packet...</div>
            </div>
        );
    }
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <p className="text-slate-300">
                            {isToday ? "Your adventure begins today!" :
                                isPast ? "We hope you enjoyed your stay!" :
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-100">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-4 border-t border-slate-100">
                        <div>
                            ...
                            <p className="font-semibold text-slate-900">{format(new Date(reservation.arrivalDate), "MMM d")}</p>
                            <p className="text-xs text-slate-400">After 2:00 PM</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-500 mb-1">Check-out</p>
                            <p className="font-semibold text-slate-900">{format(new Date(reservation.departureDate), "MMM d")}</p>
