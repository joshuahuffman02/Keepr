...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Keepr - the platform connecting outdoor enthusiasts with amazing campgrounds.",
};
    ...
    <div className="min-h-screen bg-keepr-off-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">About Keepr</h1>
        ...
        <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12 mb-12">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-muted-foreground mb-4">
              Keepr was founded with a simple belief: that the great outdoors should be accessible
              to everyone. We&apos;ve built a platform that connects campers with amazing
              campgrounds while giving campground owners the tools they need to succeed.
            </p>
            <p className="text-muted-foreground mb-4">
              Whether you&apos;re a first-time camper looking for the perfect spot or a seasoned
              RVer planning your next adventure, Keepr makes it easy to find, book, and enjoy your
              outdoor experience.
            </p>
        ...
        <div className="bg-card rounded-2xl shadow-lg p-8 md:p-12 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-keepr-evergreen mt-1">•</span>A modern, actively built
                  campground management tool
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-keepr-evergreen mt-1">•</span>A collaboration with early
                  adopters who shape the product
                </li>
                <li className="flex items-start gap-2">
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-slate-400 mt-1">•</span>A finished enterprise system (yet)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-slate-400 mt-1">•</span>A replacement for your only backup
                  today
                </li>
                <li className="flex items-start gap-2">
          ...
          <p className="mt-6 text-sm text-muted-foreground border-t border-border pt-6">
            We&apos;re building Keepr alongside our founding parks. Your feedback directly
            influences what we build next.
            <a href="/roadmap" className="text-keepr-evergreen hover:underline ml-1">
              View our roadmap →
            </a>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-card rounded-xl p-6 shadow-lg">
            <div className="w-12 h-12 bg-keepr-evergreen/10 rounded-lg flex items-center justify-center mb-4">
              <svg
                className="w-6 h-6 text-keepr-evergreen"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="bg-card rounded-xl p-6 shadow-lg">
            <div className="w-12 h-12 bg-keepr-charcoal/10 rounded-lg flex items-center justify-center mb-4">
              <svg
                className="w-6 h-6 text-keepr-charcoal"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
