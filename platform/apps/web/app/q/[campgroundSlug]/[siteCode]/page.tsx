            ...
            <div className="max-w-md mx-auto space-y-6">
                ...
                <Card className="border-t-4 border-t-primary shadow-lg overflow-hidden">
                    ...
                    <CardHeader className="text-center pb-2">
                        ...
                        <CardTitle className="text-3xl font-bold">{site.siteClass?.name || "Standard Site"}</CardTitle>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        {isAvailable ? (
                            <div className="bg-green-50 p-4 rounded-lg border border-green-100 text-center">
                                ...
                                <p className="text-3xl font-bold text-green-700">$45<span className="text-sm font-normal text-green-600">/night</span></p>
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 text-center">
                                ...
                                <div className="mt-4 pt-4 border-t border-blue-200">
                                    ...
                                    <Button size="sm" variant="outline" className="w-full bg-white text-blue-700 hover:bg-blue-50">Log In to Unlock</Button>
                                </div>
                            </div>
                        )}
                ...
                <div className="text-center text-sm text-gray-500">
                    <p>Need help? Call <a href="tel:+15550199" className="underline">Front Desk</a></p>
                </div>
            </div>
        </div>
    );
