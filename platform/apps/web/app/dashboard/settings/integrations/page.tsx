...
export default function IntegrationsSettingsPage() {
  ...
  const disconnectMutation = useMutation({
    mutationFn: (connectionId: string) => apiClient.deleteIntegrationConnection(connectionId),
    onSuccess: () => {
    ...
    try {
      ...
      if (oauthData.error) {
        ...
        toast({
          ...
          description:
            oauthData.message || "Contact support to enable this integration for your account.",
          variant: "destructive",
        });
        return;
      }
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-medium text-amber-900">Integrations Beta</p>
      ...
      {!campgroundId && !connectionsQuery.isLoading && (
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-foreground">No campground selected</h3>
        ...
        <div className="space-y-10">
          {integrationCategories.map((category, categoryIndex) => {
            ...
            return (
              ...
              >
                <div className="mb-4">
                  <h2 className="text-lg font-semibold text-foreground">{categoryInfo.label}</h2>
        ...
        !searchQuery && (
          ...
          >
            ...
            <p className="text-muted-foreground mt-1 max-w-md mx-auto">
              Link CampReserv with QuickBooks, Xero, or your CRM to keep everything in sync
              automatically.
            </p>
          </motion.div>
        )}
