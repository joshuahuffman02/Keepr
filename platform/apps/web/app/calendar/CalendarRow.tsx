...
export const CalendarRow = memo(function CalendarRow({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "px-4 py-3 sticky left-0 z-20 border-r border-border flex flex-col justify-center",
          zebra,
        )}
      >
        <div className="flex items-center justify-between gap-2">
          <div className="min-w-0">
            <div className="text-sm font-bold text-foreground truncate" title={site.name}>
              {site.name}
            </div>
