...
export const RowSelectionOverlay = ({ siteId, siteName, dayCount }: RowSelectionOverlayProps) => {
    ...
    return (
        <div
            className="absolute inset-y-1 mx-0.5 rounded-lg bg-status-info/30 border-2 border-status-info z-30 pointer-events-none flex items-center justify-center overflow-hidden shadow-[0_0_15px_rgba(59,130,246,0.3)]"
            style={{
