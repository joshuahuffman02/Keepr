            ...
            <Card>
              <CardHeader>
                ...
                {wallets.length > 1 && !selectedWalletId && (
                  <CardDescription>Select a wallet above to view transactions</CardDescription>
                )}
              </CardHeader>
              <CardContent>
                {loadingTransactions ? (
        ...
        <Dialog open={!!deleteCardConfirm} onOpenChange={() => setDeleteCardConfirm(null)}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This will remove the card from your account. You can add it again later when making
                a payment.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
