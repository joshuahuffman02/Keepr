...
export const roadmapPhases: RoadmapPhase[] = [
  {
    ...
    description:
      "Core platform architecture, multi-tenant data model, ledger system, and payment processing — the bedrock everything else builds on.",
    status: "in_progress",
    order: 1,
    icon: "building-2",
    color: "emerald",
    milestones: [
      {
        ...
        description: "NestJS + Prisma API, Next.js frontend, shared Zod types",
        status: "completed",
      },
      {
        id: "multi-org",
        name: "Multi-org tenancy",
        description: "Organization → Campground → Site hierarchy with role-based access",
        status: "completed",
      },
      {
        id: "ledger-system",
        name: "Ledger system",
        description: "GL codes, double-entry journal entries, financial tracking",
        status: "completed",
      },
      {
        ...
        description:
          "Stripe Payment Intents, refunds, deposit captures (code ready, pending Stripe account setup)",
        status: "in_progress",
      },
      {
        id: "tax-config",
        name: "Tax configuration",
        description: "State/local tax rates per campground",
        status: "completed",
      },
      {
        id: "dashboard-shell",
        name: "Dashboard shell",
        description: "Sidebar navigation, breadcrumbs, responsive layout",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Full reservation lifecycle from initial booking to checkout, plus flexible pricing with seasonal rates, weekend premiums, and dynamic rules.",
    status: "completed",
    order: 2,
    icon: "calendar-days",
    color: "blue",
    milestones: [
      {
        id: "site-classes",
        name: "Site classes",
        description: "Group sites by type (RV, tent, cabin) with default rates and amenities",
        status: "completed",
      },
      {
        id: "dynamic-pricing",
        name: "Dynamic pricing rules",
        description: "Weekend, seasonal, holiday, and event-based pricing adjustments",
        status: "completed",
      },
      {
        id: "reservation-workflow",
        name: "Reservation workflow",
        description: "Create, confirm, check-in, check-out, and cancel flows",
        status: "completed",
      },
      {
        id: "deposit-rules",
        name: "Deposit rules",
        description: "First night, full payment, or percentage-based deposits",
        status: "completed",
      },
      {
        id: "calendar-view",
        name: "Calendar view",
        description: "Visual timeline of reservations across all sites",
        status: "completed",
      },
      {
        id: "blackout-dates",
        name: "Blackout dates",
        description: "Block dates for maintenance, private events, or closures",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Guest accounts, on-site portal with ordering and messaging, add-ons, and self-service capabilities that transform when guests check in.",
    status: "completed",
    order: 3,
    icon: "users",
    color: "violet",
    milestones: [
      {
        id: "guest-profiles",
        name: "Guest profiles",
        description: "Contact info, vehicle details, preferences, notes",
        status: "completed",
      },
      {
        id: "guest-accounts",
        name: "Guest accounts",
        description: "Account creation via reservation, magic link auth, reservation lookup",
        status: "completed",
      },
      {
        id: "guest-portal",
        name: "Guest portal",
        description:
          "My Stay page that transforms when checked in — view reservation, site info, campground details",
        status: "completed",
      },
      {
        id: "onsite-ordering",
        name: "On-site ordering",
        description:
          "Order store items to site, request add-ons, pay by card or charge to reservation",
        status: "completed",
      },
      {
        id: "portal-upsells",
        name: "Portal upsells",
        description:
          "Contextual upsell cards in the guest portal with offline queuing per campground",
        status: "completed",
      },
      {
        id: "guest-messaging",
        name: "Message the office",
        description: "In-portal messaging between guests and front desk staff",
        status: "completed",
      },
      {
        id: "communication-hub",
        name: "Communication hub",
        description: "Email/SMS history, templates, and automated sends",
        status: "completed",
      },
      {
        id: "loyalty-tracking",
        name: "Loyalty tracking",
        description: "Repeat stays counter, rewards, VIP tiers",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Real-time availability engine with rig-fit matching, public booking widgets, hold systems, and waitlist notifications.",
    status: "completed",
    order: 4,
    icon: "search",
    color: "amber",
    milestones: [
      {
        ...
        description: "Live site availability API with caching",
        status: "completed",
      },
      {
        id: "rig-fit",
        name: "Rig-fit matching",
        description: "Filter sites by RV length, slide-outs, and hookup requirements",
        status: "completed",
      },
      {
        id: "booking-widget",
        name: "Online booking widget",
        description: "Embeddable public booking form for any website",
        status: "completed",
      },
      {
        id: "hold-system",
        name: "Hold system",
        description: "Temporary holds during checkout to prevent double-booking",
        status: "completed",
      },
      {
        id: "waitlist",
        name: "Waitlist",
        description: "Notify guests when their desired dates become available",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Public-facing campground pages, SEO optimization, promotional campaigns, and comprehensive reporting dashboards.",
    status: "completed",
    order: 5,
    icon: "bar-chart-3",
    color: "rose",
    milestones: [
      {
        id: "public-pages",
        name: "Public campground pages",
        description: "Detail pages with photos, amenities, site types, events",
        status: "completed",
      },
      {
        id: "seo",
        name: "SEO optimization",
        description: "Meta tags, Open Graph, structured data for search engines",
        status: "completed",
      },
      {
        id: "promotions",
        name: "Promotions & discounts",
        description: "Coupon codes, early-bird rates, package deals",
        status: "completed",
      },
      {
        id: "reports",
        name: "Reports dashboard",
        description: "Occupancy, revenue, guest analytics, and trends",
        status: "completed",
      },
      {
        id: "pickup-reporting",
        name: "Pickup reporting",
        description: "Demand pickups with 7/30/90-day and weekly/monthly rollups plus CSV export",
        status: "completed",
      },
      {
        id: "email-campaigns",
        name: "Email campaigns",
        description: "Newsletter integration, automated marketing sequences",
        status: "completed",
      },
      {
        id: "lead-capture",
        name: "Lead capture & CRM sync stub",
        description:
          "Landing-page lead forms, admin lead board with statuses, and stubbed CRM sync",
        status: "completed",
      },
      {
        id: "promo-analytics",
        name: "Promo analytics & redemptions",
        description: "Promo usage, redemptions, and filters in marketing reports",
        status: "completed",
      },
    ],
  },
  {
    ...
    name: "Store & Add-ons",
    description:
      "Camp store inventory management, product catalog, add-on services (late checkout, early check-in), and unified ordering for staff and guests.",
    status: "completed",
    order: 6,
    icon: "shopping-cart",
    color: "orange",
    milestones: [
      {
        ...
        description: "Store items with categories, pricing, images, and inventory tracking",
        status: "completed",
      },
      {
        id: "addon-services",
        name: "Add-on services",
        description: "Late checkout, early check-in, extra vehicle, pet fees, firewood delivery",
        status: "completed",
      },
      {
        id: "staff-pos",
        name: "Staff POS",
        description: "Front desk checkout interface with cart, apply to reservation or pay now",
        status: "completed",
      },
      {
        id: "gift-cards",
        ...
        description:
          "Issue/redeem codes with balance/expiry plus usage history (local-only stub, no processors)",
        status: "completed",
      },
      {
        id: "inventory-mgmt",
        name: "Inventory management",
        description: "Stock levels, low-stock alerts, reorder tracking",
        status: "completed",
      },
      {
        id: "charge-to-site",
        name: "Charge to site",
        description: "Add purchases to reservation balance, settle at checkout",
        status: "completed",
      },
      {
        id: "pos-refunds",
        name: "POS refunds/exchanges",
        description:
          "Record refunds or exchanges against recent POS orders with notes (stubbed, no processor call)",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Activity management, session scheduling, and guest booking for events, tours, and equipment rentals.",
    status: "completed",
    order: 7,
    icon: "ticket",
    color: "pink",
    milestones: [
      {
        ...
        description: "Create and manage activities with photos and details",
        status: "completed",
      },
      {
        id: "session-scheduling",
        name: "Session scheduling",
        description: "Schedule recurring or one-off sessions with capacity limits",
        status: "completed",
      },
      {
        id: "guest-booking",
        name: "Guest booking",
        description: "Guests can browse and book activities via the portal",
        status: "completed",
      },
      {
        id: "equipment-rental",
        name: "Equipment rental",
        description: "Manage rental inventory and bookings",
        status: "completed",
      },
      {
        id: "activities-rentals-depth",
        name: "Activities & rentals depth",
        description: "Per-activity caps, waitlists, and overage handling",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Interactive map interface, maintenance management, events calendar, OTA integrations, and mobile apps.",
    status: "completed",
    order: 8,
    icon: "rocket",
    color: "cyan",
    milestones: [
      {
        ...
        description: "Visual drag-and-drop site picker with live availability status",
        status: "completed",
      },
      {
        id: "maintenance",
        name: "Maintenance system",
        description: "Work orders, scheduling, site blocking, vendor tracking",
        status: "completed",
      },
      {
        id: "events",
        name: "Events calendar",
        description: "Activities, workshops, entertainment, and guest reminders",
        status: "completed",
      },
      {
        id: "ota-ical",
        name: "OTA iCal & mappings",
        description:
          "Per-listing iCal feeds, imports to blackouts, mapping/status logs, and availability push stubs",
        status: "completed",
      },
      {
        id: "ota",
        ...
        description:
          "Two-way sync with Hipcamp, RoverPass, and other platforms (provider API wiring pending creds; iCal live)",
        status: "completed",
      },
      {
        id: "mobile-app",
        name: "Mobile app",
        description: "Native iOS/Android app for guests and staff",
        status: "completed",
      },
    ],
  },
  {
    ...
    milestones: [
      {
        id: "pre-ship-qa-polish",
        name: "Pre-ship QA & UI polish",
        description:
          "Full QA across dev/staging/prod, nav cleanup, security/privacy checks, and ship-blocker fixes.",
        status: "completed",
      },
      {
        id: "ship-checklist",
        name: "Ship checklist sign-off",
        description: "Condensed re-smoke, known-limits doc, and launch readiness checklist.",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "NPS collection, automated outreach, review capture, public reputation, and admin controls.",
    status: "completed",
    order: 9,
    icon: "star",
    color: "amber",
    milestones: [
      {
        id: "nps-core",
        name: "NPS core + metrics",
        description:
          "Surveys, invites, responses, detractor alerts/tickets, promoter → review request bridge",
        status: "completed",
      },
      {
        ...
        description:
          "Admin dashboard with NPS snapshot, survey creation, manual invites, review moderation",
        status: "completed",
      },
      {
        id: "public-reviews",
        name: "Public reviews UX",
        description:
          "Public reviews on campground pages with filters (rating, tags, photos-only), search, relevance/newest, photo-first, rating distribution, lazy load",
        status: "completed",
      },
      {
        id: "auto-post-checkout-nps",
        name: "Auto post-checkout NPS",
        description:
          "Behind-the-scenes: cron + template to send 7am day-after checkout; needs camp-level settings re-added (npsAutoSendEnabled/npsSendHour) after schema removal",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Deliverability, templates, sequences, and smart inbox workflows across guest/staff messaging.",
    status: "completed",
    order: 9,
    icon: "message-circle",
    color: "emerald",
    milestones: [
      {
        id: "provider-health",
        name: "Deliverability & provider health",
        description: "DMARC/DKIM/SPF checks, bounce monitoring, and provider failover",
        status: "completed",
      },
      {
        id: "templating",
        name: "Template library & approvals",
        description: "Shared components, preview/testing, approvals for outbound comms",
        status: "completed",
      },
      {
        ...
        description:
          "Event-based sequences for arrivals, unpaid balances, upsells, and abandoned carts",
        status: "completed",
      },
      {
        id: "inbox-routing",
        name: "Smart inbox routing",
        description: "Auto-triage, SLAs, and response suggestions for guest/staff threads",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Referral loops, promotions performance, lifecycle nudges, and attribution across channels.",
    status: "completed",
    order: 10,
    icon: "trending-up",
    color: "blue",
    milestones: [
      {
        ...
        description: "Capture and retarget public booking drop-offs with email/SMS",
        status: "completed",
      },
      {
        id: "referrals",
        name: "Referrals & affiliates",
        description: "Referral links, affiliate tracking, and rewards",
        status: "completed",
      },
      {
        id: "promo-optimizer",
        name: "Promo performance insights",
        description: "Promo code usage, channel lift, and A/B experiments",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "In-app content planning system with smart suggestions, templates, content bank, and reporting to drive occupancy and engagement—no external auto-posting.",
    status: "completed",
    order: 10,
    icon: "megaphone",
    color: "fuchsia",
    milestones: [
      {
        ...
        description:
          "Month/week/list views, drag/drop posts, platform tags, idea parking lot, auto slot generation, filters, and status states.",
        status: "completed",
      },
      {
        id: "smp-suggestions",
        ...
        description:
          "Recommendations from occupancy/events/deals/seasonality/history with opportunity alerts for gaps, countdowns, and promos.",
        status: "completed",
      },
      {
        id: "smp-weekly-ideas",
        name: "Weekly auto-generated ideas",
        description:
          "Monday bundles with 3 post ideas (promo/engagement/behind-the-scenes) plus recommended cadence.",
        status: "completed",
      },
      {
        id: "smp-post-builder",
        name: "Post builder & AI assists",
        description:
          "Platform selector, captions with AI tone transforms, hashtags, image prompts, CTA options, templates, attachments.",
        status: "completed",
      },
      {
        id: "smp-templates",
        ...
        description:
          "Reusable templates by content type and style with caption fill-ins, image instructions, hashtags, and best time guidance.",
        status: "completed",
      },
      {
        id: "smp-content-bank",
        name: "Saved content bank",
        description:
          "Library for photos/videos/logos/design elements/past high-performers/brand captions prioritized by suggestions.",
        status: "completed",
      },
      {
        id: "smp-reporting",
        ...
        description:
          "Posts created, template usage, suggested vs completed, category usage, consistency score, manual performance inputs.",
        status: "completed",
      },
      {
        id: "smp-team",
        name: "Team workflows",
        description:
          "Comments on drafts, assignments, approvals, shared idea lists, optional gamification for contribution.",
        status: "completed",
      },
      {
        id: "smp-strategy",
        ...
        description:
          "Monthly strategy builder, annual planner, and opportunity alerts (weather, occupancy spikes, new inventory, inactivity).",
        status: "completed",
      },
      {
        id: "smp-captions",
        ...
        description:
          "Tone presets (short/long/funny/warm/promo/story) with local/seasonal/event/deal hashtag sets.",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Privacy-first event tracking, conversion insights, recommendations with permissions-gated Apply buttons, and forecasting/ML readiness.",
    status: "completed",
    order: 11,
    icon: "brain",
    color: "violet",
    milestones: [
      {
        id: "event-tracking-layer",
        name: "Event tracking layer",
        description:
          "Structured events across booking flow (views, add-to-stay, abandon/complete) with session/device/referrer/region",
        status: "completed",
      },
      {
        id: "image-conversion",
        name: "Image conversion analytics",
        description: "First-seen order, dwell time, CTR, A/B ordering, and heat ranks per image",
        status: "completed",
      },
      {
        id: "site-conversion",
        name: "Site & site-class conversion",
        description:
          "View → detail → add-to-stay → conversion/abandonment with price sensitivity and filter attribution",
        status: "completed",
      },
      {
        ...
        description:
          "Optimal rates, revenue vs occupancy tradeoffs, sensitivity curves, and 6-week/holiday guidance",
        status: "completed",
      },
      {
        id: "deal-analytics",
        name: "Deal performance analytics",
        description: "Views/clicks/use rate, incremental lift, and channel attribution for deals",
        status: "completed",
      },
      {
        ...
        description:
          "Actionable insights with explanation, confidence, projected impact, and Apply/Update buttons gated by permissions",
        status: "completed",
      },
      {
        ...
        name: "Reports dashboard",
        description:
          "Funnel, image performance, pricing/occupancy, deals, channel attribution, and forecasting tabs",
        status: "completed",
      },
      {
        id: "ab-testing",
        name: "A/B testing",
        description:
          "Image order, pricing, deal headline/layout variants with autosuggested winners",
        status: "completed",
      },
      {
        id: "permissions-privacy",
        name: "Permissions & privacy guardrails",
        description:
          "Admin/Manager apply controls, Analyst propose/export, Viewer read-only; aggregated/region-safe analytics with retention rules",
        status: "completed",
      },
      {
        id: "annual-report",
        name: "Annual data report",
        description:
          "Auto-generated PDF/CSV/share link covering revenue, occupancy, best performers, deals, trends, and next-year strategy",
        status: "completed",
      },
      {
        id: "ml-future",
        name: "ML forecasting & alerts",
        description:
          "Predictive pricing, booking window timing, return-guest likelihood, oversell warnings, and interest-drop alerts",
        status: "completed",
      },
    ],
  },
    ...
    milestones: [
      {
        id: "audit-trails",
        name: "Audit trails",
        description: "Immutable event logging with staff attribution and export",
        status: "completed",
      },
      {
        id: "granular-permissions",
        name: "Granular permissions",
        description: "Field-level RBAC, scoped roles, and approvals",
        status: "completed",
      },
      {
        id: "privacy-controls",
        name: "Privacy & PII controls",
        description: "Redaction, key management, and consent logging",
        status: "completed",
      },
      {
        id: "compliance",
        name: "Compliance readiness",
        description: "SOC 2 controls, backups, data retention, and DPA tooling",
        status: "completed",
      },
      {
        id: "branding-controls",
        name: "Branding controls",
        description: "Logo, color, font, email header/footer applied to guest touchpoints",
        status: "completed",
      },
      {
        id: "cancellation-policies",
        name: "Cancellation policies",
        description: "Structured policy type/window/fees with email display",
        status: "completed",
      },
      {
        id: "forms-checkin",
        name: "Forms & check-in blocking",
        description: "Form templates, submissions, and check-in blocked until completed",
        status: "completed",
      },
    ],
  },
    ...
    milestones: [
      {
        ...
        description: "Tracing/metrics/logs with user-impact SLOs and alerting",
        status: "completed",
      },
      {
        id: "perf-budgets",
        name: "Performance budgets",
        description: "Lighthouse/RUM budgets with regression gates in CI",
        status: "completed",
      },
      {
        id: "rate-limits",
        name: "Rate limits & queuing",
        description: "Defensive rate limits, background jobs, and retries",
        status: "completed",
      },
      {
        id: "dr-readiness",
        name: "Disaster recovery",
        description: "Backups, chaos drills, and regional failover plan",
        status: "completed",
      },
    ],
  },
    ...
    milestones: [
      {
        id: "public-api",
        name: "Public API",
        description: "OAuth2 + scoped tokens with per-campground access",
        status: "completed",
      },
      {
        id: "webhooks",
        name: "Webhooks",
        description: "Signed webhooks for reservations, payments, and events",
        status: "completed",
      },
      {
        id: "sdk-sandbox",
        name: "SDKs & sandbox",
        description: "TypeScript/React SDK, test data seeding, and mocks",
        status: "completed",
      },
      {
        id: "extensions",
        name: "Extensibility",
        description: "Embeds/blocks for partner apps inside the dashboard",
        status: "completed",
      },
    ],
  },
  {
    ...
    milestones: [
      {
        id: "platform-fees",
        name: "Platform fees & plans",
        description: "Per-booking fees and plans via Stripe Connect",
        status: "completed",
      },
      {
        id: "payout-recon",
        name: "Payout reconciliation",
        description: "Daily/weekly payouts, fee capture, exports, and alerts for misses",
        status: "completed",
      },
      {
        id: "ledger-audit",
        name: "Ledger tie-out & auditability",
        description: "Double-entry for platform/Stripe fees, payout journal, audit/export hooks",
        status: "completed",
      },
      {
        id: "ach-wallets",
        name: "ACH & wallets",
        description: "ACH, Apple/Google Pay, saved payment methods with mandates and retries",
        status: "completed",
      },
      {
        id: "chargebacks",
        name: "Chargeback center",
        description: "Dispute queue with evidence kits, webhook ingestion, and alerting",
        status: "completed",
      },
    ],
  },
    ...
    milestones: [
      {
        id: "auto-tasking",
        name: "Auto-tasking",
        description: "Trigger maintenance/housekeeping tasks from events",
        status: "completed",
      },
      {
        id: "checklists",
        name: "Checklists & SOPs",
        description: "Reusable playbooks with due-times and owners",
        status: "completed",
      },
      {
        id: "inventory-reorders",
        name: "Inventory reorders",
        description: "Par levels with vendor reorders and approvals",
        status: "completed",
      },
      {
        id: "ops-copilot",
        name: "Operations copilot",
        description: "Suggested replies, task bundling, and smart routing",
        status: "completed",
      },
    ],
  },
  {
    ...
    name: "Mobile & Offline",
    description:
      "Field-ready staff tools, offline kiosk/pos, and resilient sync for low-connectivity parks.",
    status: "completed",
    order: 17,
    icon: "smartphone",
    color: "emerald",
    milestones: [
      {
        id: "pwa-lite",
        name: "Guest & staff PWA slices",
        description:
          "Lightweight PWA for arrivals/tasks and guest stay with messaging, orders-to-site requests, events, and offline queuing",
        status: "completed",
      },
      {
        id: "pwa-offline-hardening",
        name: "Offline cache & queues",
        description:
          "Service worker precache/runtime cache, indexedDB queues with retry/backoff, conflict handling, and sync telemetry",
        status: "completed",
      },
      {
        id: "offline-pos",
        name: "Offline POS/kiosk",
        description: "Take payments and issue passes offline with sync queue",
        status: "completed",
      },
      {
        id: "staff-mobile",
        name: "Staff mobile",
        description: "Work orders, arrivals, and messaging on mobile",
        status: "completed",
      },
      {
        id: "guest-mobile",
        name: "Guest mobile",
        description: "Guest stay app with offline map and orders",
        status: "completed",
      },
      {
        id: "push-notifs",
        name: "Push notifications",
        description: "Transactional and marketing pushes with preferences",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Accounting, access control, CRM/helpdesk, and exports to meet operators where they are.",
    status: "completed",
    order: 18,
    icon: "plug",
    color: "blue",
    milestones: [
      {
        ...
        description: "QuickBooks/Xero mappings, reconciliation, and exports",
        status: "completed",
      },
      {
        id: "access-control",
        name: "Access control",
        description: "Smart lock/RFID integrations for gates and doors",
        status: "completed",
      },
      {
        id: "crm-helpdesk",
        name: "CRM/helpdesk",
        description: "Sync guests to HubSpot/Intercom/Zendesk with tickets",
        status: "completed",
      },
      {
        id: "data-exports",
        name: "Data export APIs",
        description: "Self-serve exports and SFTP drops for operators",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Richer data-driven recommendations, semantic search, and assistant-style workflows.",
    status: "completed",
    order: 19,
    icon: "sparkles",
    color: "violet",
    milestones: [
      {
        ...
        description: "Site/upsell recommendations based on guest intent",
        status: "completed",
      },
      {
        id: "dynamic-pricing-ai",
        name: "Dynamic pricing AI",
        description: "Price suggestions using demand, comps, and rules",
        status: "completed",
      },
      {
        id: "semantic-search",
        name: "Semantic search",
        description: "Natural language search across guests, sites, and messages",
        status: "completed",
      },
      {
        id: "copilot",
        name: "Copilot",
        description: "Assistant for bulk changes, replies, and what-if planning",
        status: "completed",
      },
    ],
  },
  {
    ...
    milestones: [
      {
        id: "multi-property",
        name: "Multi-property ops",
        description: "Portfolio views, cross-park reporting, and routing",
        status: "completed",
      },
      {
        id: "localization",
        name: "Localization",
        description: "Multi-language UI and content with locale-aware formatting",
        status: "completed",
      },
      {
        id: "multi-currency",
        name: "Multi-currency & tax",
        description: "FX handling, VAT/GST, and regional tax rules",
        status: "completed",
      },
      {
        id: "approvals",
        name: "Approvals & controls",
        description: "Dual control for refunds, payouts, and high-value changes",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Contextual help, inline guidance, and in-app support reporting with routed triage.",
    status: "completed",
    order: 21,
    icon: "life-buoy",
    color: "slate",
    milestones: [
      {
        ...
        description:
          "Slide-in help panel, /help hub, search, pinned/recent, role-aware filters, task pills, Shift+? shortcut",
        status: "completed",
      },
      {
        id: "inline-anchors",
        name: "Inline help anchors",
        description: "“?” anchors across admin pages linking to relevant help topics",
        status: "completed",
      },
      {
        id: "support-reporting",
        name: "In-app support reporting",
        description: "Report form with auto-captured context, backend storage, admin queue",
        status: "completed",
      },
      {
        id: "support-routing",
        name: "Support routing & alerts",
        description: "Slack/email alerts, assignee picker, assignment notifications",
        status: "completed",
      },
      {
        id: "regional-scoping",
        name: "Regional access & routing",
        description: "Scope triage visibility/assignment by region/ownership roles",
        status: "completed",
      },
      {
        id: "staff-directory",
        name: "Global staff directory",
        description: "Cross-camp staff list for assignment and notifications",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Mature, staff-only XP/levels tied to real work with challenges, badges, and dashboards. Opt-in per campground; guests never see it.",
    status: "completed",
    order: 22,
    icon: "target",
    color: "purple",
    milestones: [
      {
        ...
        name: "XP system",
        description:
          "XP for tasks, maintenance, check-ins, zero-error reservations, checklists, positive reviews, on-time assignments, and assists; light penalties for overdue/mistakes.",
        status: "completed",
      },
      {
        id: "levels",
        name: "Levels & perks",
        description:
          "Progression tiers with profile badges, early feature access, improvement-proposal queue, subtle themes.",
        status: "completed",
      },
      {
        id: "weekly-challenges",
        name: "Weekly challenges",
        description: "Auto-generated operational challenges with bonus XP and badges.",
        status: "completed",
      },
      {
        id: "leaderboards",
        name: "Leaderboards",
        description:
          "Category leaderboards (tasks, guest rating, check-in speed, cleanliness, consistency) with weekly/monthly resets.",
        status: "completed",
      },
      {
        id: "badges",
        ...
        description:
          "Legit work-based badges (Rain or Shine, Fix It First, Guest Hero, Check-In Champion, Event Support Pro, Clean Sweep).",
        status: "completed",
      },
      {
        ...
        description:
          "Per-staff XP bar, level, badges, challenge status, leaderboard placement, task analytics, guest mentions, response times; manager team summaries.",
        status: "completed",
      },
      {
        id: "smart-notifs",
        ...
        description:
          "Encouraging nudges (e.g., “40 XP to Level 4—complete 3 tasks”, challenge countdowns, new badges).",
        status: "completed",
      },
      {
        id: "streaks-competitions",
        name: "Streaks & team comps (optional)",
        description: "Healthy streaks and friendly team competitions with XP/badge rewards.",
        status: "completed",
      },
      {
        id: "opt-in-controls",
        name: "Opt-in & manager controls",
        description: "Camp-level toggle; manager XP ranges, overrides, and manual Merit XP.",
        status: "completed",
      },
      {
        id: "anti-cheese",
        name: "Anti-cheese design",
        description: "Subtle, CRM/fitness-inspired visuals; no cartoon graphics or playful sounds.",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "POS/store resilience, guest/portal polish, trust/PII controls, OTA iCal sync, finance fixes.",
    status: "completed",
    order: 23,
    icon: "wrench",
    color: "slate",
    milestones: [
      {
        id: "pos-offline",
        name: "POS offline queue & sync log",
        description:
          "Queue orders, show sync state, charge-to-site hardening, refunds/credits, low-stock alerts",
        status: "completed",
      },
      {
        id: "guest-portal-polish",
        name: "Guest portal polish",
        description:
          "Comms timeline, delivery/curbside, assigned-on-arrival booking, order status, offline-friendly My Stay",
        status: "completed",
      },
      {
        id: "trust-privacy",
        ...
        description:
          "Permissions guardrails, approval flows, audit/PII redaction, backups/restore-sim, retention",
        status: "completed",
      },
      {
        id: "ota-ical-next",
        name: "OTA iCal sync",
        description: "Per-listing calendar export/import with sync status and error badges",
        status: "completed",
      },
      {
        id: "finance-fixes",
        name: "Finance fixes",
        description:
          "Payouts/disputes views, deposits v2, ledger/tax sanity checks, finance seed fixtures",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Two-way OTA, support/ops tooling, reporting/exports, integrations, and offline/PWA resilience.",
    status: "completed",
    order: 24,
    icon: "waves",
    color: "indigo",
    milestones: [
      {
        id: "ota-two-way",
        name: "Two-way OTA",
        description: "Availability/rates/reservations with logs, retry, per-channel status",
        status: "completed",
      },
      {
        id: "support-ops",
        name: "Support & Ops",
        description: "SLA/overdue, ticketing, staff chat, ops tasks with photos/routes/checklists",
        status: "completed",
      },
      {
        ...
        description:
          "Pickup/pace, saved reports, CSV/S3 export, warehouse connector stub, scheduled exports",
        status: "completed",
      },
      {
        id: "integrations-wave1",
        name: "Integrations wave 1",
        description:
          "Accounting (payout/GL export), helpdesk/CRM, access control stubs, webhook retry/logs",
        status: "completed",
      },
      {
        id: "pwa-offline",
        name: "PWA/offline",
        description:
          "Queued orders/payments/messages, push notifications, visible sync state, conflict resolution",
        status: "completed",
      },
    ],
  },
    ...
    milestones: [
      {
        ...
        description:
          "OAuth2 sandbox, SDKs, client generators, webhook retry/logs, API usage tracking",
        status: "completed",
      },
      {
        id: "ai-assist",
        name: "AI assist",
        description:
          "Replies, task bundling, routing, smart search, real anomaly detection with z-score analysis",
        status: "completed",
      },
      {
        id: "iot-hooks",
        name: "IoT hooks",
        description:
          "QR code check-in, site QR codes, device registry, smart lock/meter simulation",
        status: "completed",
      },
      {
        id: "enterprise-international-next",
        name: "Enterprise & international depth",
        description: "Full i18n with 14 locales, multi-currency support, regional tax profiles",
        status: "completed",
      },
    ],
  },
  {
    ...
    description:
      "Enable guests to round up their reservation total to donate to campground-selected charities, with full accounting integration and reporting.",
    status: "completed",
    order: 26,
    icon: "heart",
    color: "rose",
    milestones: [
      {
        id: "charity-models",
        name: "Charity data models",
        description:
          "Charity registry, campground charity selection, donation tracking, and payout management",
        status: "completed",
      },
      {
        id: "charity-admin",
        name: "Charity admin UI",
        description:
          "Platform charity management, campground charity settings, enable/disable round-up",
        status: "completed",
      },
      {
        id: "roundup-checkout",
        name: "Round-up at checkout",
        description:
          "Guest opt-in UI during booking with charity info, round-up amount, and custom donation options",
        status: "completed",
      },
      {
        id: "charity-accounting",
        name: "Charity accounting",
        description:
          "Separate GL code for donations, liability tracking, journal entries, and payout reconciliation",
        status: "completed",
      },
      {
        id: "charity-reporting",
        name: "Charity reporting",
        description:
          "Donation totals, opt-in rates, per-charity breakdown, payout history, and tax exports",
        status: "completed",
      },
    ],
  },
...
export const updates: Update[] = [
  {
    ...
    whatChanged:
      'Added support for "New", "Update", "Enhancement", and "Fix" badges. Updates now group by month and include detailed sections for what changed, why it matters, and who it helps. Added support for screenshots and demo videos.',
    whyItMatters:
      "Transparent communication about product changes helps campground operators understand how features affect their daily operations and plan for adoption.",
    whoItHelps:
      "All users benefit from clearer product communication. Managers and owners can track feature rollouts and plan staff training accordingly.",
  ...
  },
  {
    ...
    whatChanged:
      "The BookingSidebar component now calls the /quotes API endpoint to get accurate pricing including all fees, taxes, and seasonal adjustments.",
    whyItMatters:
      "Guests and front desk staff now see exact pricing during the booking process, reducing confusion and pricing errors at checkout.",
  ...
  },
  {
    ...
    whatChanged:
      "Maintenance tickets now have quick action buttons for assigning, marking in progress, and completing. Click on any ticket to edit details inline.",
    whyItMatters:
      "Reduces time spent managing maintenance requests from multiple clicks to a single action. Staff can triage and update tickets faster during busy periods.",
  ...
  },
  {
    ...
    title:
      "Integrations wave 1 shipped: accounting, access control, CRM/helpdesk, exports (sandbox live)",
    date: "2025-12-08",
...
export function getPhaseProgress(phase: RoadmapPhase): {
  completed: number;
  total: number;
  percentage: number;
} {
