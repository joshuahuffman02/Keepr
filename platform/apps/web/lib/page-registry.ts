...
export const PAGE_REGISTRY: PageDefinition[] = [
  ...
  },
  {
    ...
    icon: "sparkles",
    category: "operations",
    description: "AI-powered campground automation hub",
    keywords: ["ai", "assistant", "copilot", "chatbot", "automation", "autonomous"],
  },
  {
    href: "/ai/chat",
    label: "AI Chat",
  ...
  },
  {
    ...
    keywords: ["ai", "pricing", "dynamic", "revenue", "optimization", "rates"],
  },
  {
    href: "/ai/revenue",
    ...
    icon: "reports",
    category: "operations",
    description: "Revenue gap analysis and opportunity detection",
    keywords: ["ai", "revenue", "insights", "opportunities", "money"],
  },
  {
    href: "/ai/maintenance",
    ...
    icon: "wrench",
    category: "operations",
    description: "AI-detected maintenance patterns and predictions",
    keywords: ["ai", "maintenance", "predictive", "alerts", "repairs"],
  },
  {
    href: "/ai/weather",
    ...
    icon: "cloud",
    category: "operations",
    description: "Automated weather monitoring and guest notifications",
    keywords: ["ai", "weather", "alerts", "storm", "notifications"],
  },
  {
    href: "/ai/phone",
    ...
    icon: "phone",
    category: "operations",
    description: "24/7 automated call handling powered by AI",
    keywords: ["ai", "phone", "calls", "voice", "agent", "twilio"],
  },
  {
    href: "/ai/settings",
    label: "AI Settings",
    icon: "policy",
    category: "settings",
    description: "Configure AI autonomous features and thresholds",
    keywords: ["ai", "settings", "autonomous", "configuration", "autopilot"],
    permissions: ["settingsWrite"],
  },
  {
    href: "/owners",
...
export const DYNAMIC_PAGE_TEMPLATES: PageDefinition[] = [
  ...
  {
    href: "/campgrounds/[campgroundId]/seasonals",
    label: "Seasonal Guests",
    icon: "users",
    category: "operations",
    description: "Manage seasonal and long-term guests",
    keywords: ["seasonals", "monthly", "long-term", "recurring", "renewals"],
    dynamic: true,
    defaultForRoles: ["manager", "owner"],
  },
  {
    href: "/campgrounds/[campgroundId]/seasonals/rate-cards",
    label: "Seasonal Rate Cards",
    icon: "pricing",
    category: "settings",
    description: "Configure seasonal pricing, discounts, and incentives",
    keywords: ["seasonal pricing", "rate cards", "discounts", "incentives", "bonuses"],
    dynamic: true,
    permissions: ["settingsWrite"],
  },
  {
  ...
  {
    href: "/campgrounds/[campgroundId]/staff/availability",
    label: "Staff Availability",
    icon: "clock",
    category: "staff",
    description: "View and manage staff availability",
    keywords: ["availability", "schedule", "hours"],
    dynamic: true,
    permissions: ["operationsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/staff/time-off",
    label: "Time Off Requests",
    icon: "calendar",
    category: "staff",
    description: "Manage time off and PTO requests",
    keywords: ["time off", "pto", "vacation", "sick leave"],
    dynamic: true,
    permissions: ["operationsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/staff/swaps",
    label: "Shift Swaps",
    icon: "users",
    category: "staff",
  ...
  {
    href: "/campgrounds/[campgroundId]/staff/templates",
    label: "Schedule Templates",
    icon: "form",
    category: "staff",
    description: "Create and manage recurring schedule templates",
    keywords: ["template", "recurring", "weekly schedule"],
    dynamic: true,
    permissions: ["operationsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/staff/payroll",
    label: "Payroll Export",
    icon: "pricing",
    category: "staff",
    description: "Export timesheets for payroll processing",
    keywords: ["payroll", "export", "onpay", "gusto", "adp"],
    dynamic: true,
    permissions: ["financeRead"],
  },
  {
    href: "/campgrounds/[campgroundId]/staff/reports",
    label: "Timesheet Reports",
    icon: "reports",
    category: "staff",
    description: "View detailed timesheet and hours reports",
    keywords: ["timesheet", "hours", "report", "overtime"],
    dynamic: true,
    permissions: ["reportsRead"],
  },
  {
  ...
  {
    href: "/campgrounds/[campgroundId]/settings/billing",
    label: "Billing & Utilities",
    icon: "pricing",
    category: "settings",
    description: "Utility meters, readings, invoices, and late fees",
    keywords: ["utilities", "meters", "electric", "water", "invoices", "billing", "late fees"],
    dynamic: true,
    permissions: ["settingsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/marketing/referrals",
    label: "Marketing & Referrals",
    icon: "megaphone",
    category: "marketing",
    description: "Referral programs, performance tracking, and guest insights",
    keywords: ["referrals", "marketing", "affiliate", "promotions", "guest acquisition"],
    dynamic: true,
    permissions: ["settingsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/admin/data",
    label: "Data Operations",
    icon: "form",
    category: "admin",
    description: "Import/export reservations and PMS integrations",
    keywords: ["import", "export", "data", "csv", "newbook", "pms", "migration"],
    dynamic: true,
    permissions: ["settingsWrite"],
  },
  {
    href: "/campgrounds/[campgroundId]/admin/kiosk",
    label: "Kiosk Devices",
    icon: "camp",
    category: "admin",
    description: "Self-service check-in kiosks for 24/7 guest arrivals",
    keywords: ["kiosk", "self-service", "check-in", "devices", "terminals"],
    dynamic: true,
    permissions: ["settingsWrite"],
  },
  {
