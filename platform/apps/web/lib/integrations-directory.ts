...
export const INTEGRATIONS_DIRECTORY: IntegrationDefinition[] = [
    // Accounting
    {
        ...
        longDescription: "Keep your books accurate with automatic syncing of reservation revenue, payments, and refunds to QuickBooks Online. Save hours of manual data entry every week.",
        category: "accounting",
        logo: "Calculator",
        features: [
    ...
    },
    {
        ...
        longDescription: "Automatically sync your campground's financial data to Xero. Payments, invoices, and refunds flow seamlessly to your books.",
        category: "accounting",
    ...
    // CRM / Customer Support
    {
        ...
        longDescription: "Sync guest data to HubSpot CRM. Track communication history, segment guests, and run targeted marketing campaigns.",
        category: "crm",
        logo: "Users",
        features: [
            "Guest contact sync",
    ...
    },
    {
        ...
        longDescription: "Create support tickets automatically and view guest reservation history directly in Zendesk.",
        category: "crm",
        logo: "MessageSquare",
        features: [
    ...
    },
    {
        ...
        longDescription: "Provide real-time support to guests with Intercom. Guest data syncs automatically for context-rich conversations.",
        category: "crm",
        logo: "MessagesSquare",
        features: [
            "Live chat widget",
    ...
    // Access Control
    {
        ...
        longDescription: "Automatically generate and send gate codes to guests before arrival. Revoke access on checkout.",
    ...
    },
    {
        ...
        longDescription: "Integrate with Salto access control systems for seamless guest entry management.",
        category: "access_control",
        logo: "DoorOpen",
        features: [
            "Mobile key delivery",
    ...
    // Export
    {
        ...
        longDescription: "Schedule automatic exports of reservation, payment, and guest data to your SFTP server for backup or integration with other systems.",
        category: "export",
        logo: "FolderSync",
        features: [
            "Scheduled exports",
    ...
    },
    {
        ...
        longDescription: "Send reservation and payment events to your own API endpoints in real-time via webhooks.",
        category: "export",
        logo: "Webhook",
        features: [
            "Real-time webhooks",
