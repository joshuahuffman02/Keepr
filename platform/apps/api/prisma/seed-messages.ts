...
const staffChatMessages = [
  {
    ...
    lastName: "Manager",
    message:
      "Good morning team! Quick update - we're at 85% capacity this weekend. Make sure all sites are ready by noon.",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Morning! I've got check-ins starting at 2pm. Will the pool be open today? Guest is asking.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message: "Pool is good to go. Finished the filter maintenance this morning. Heating up now.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message:
      "Perfect timing Bob! Mike, yes pool opens at 10am. Let guests know towels are available at the office.",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Will do. Also, site P3 guest called - they need an early checkout tomorrow, leaving by 7am.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message: "That's fine. Make a note so housekeeping knows to prioritize P3 in the morning.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message:
      "Heads up - I noticed the water pressure is low at the T section. Going to check the main valve.",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Thanks for the heads up. I'll let any tent site check-ins know there might be a brief interruption.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message: "Good communication everyone. Bob, let us know when water is back to normal.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message:
      "Found the issue - minor leak at the junction. Fixed now, pressure should be back to normal in about 10 min.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message: "Great work! Did we get the new firewood delivery scheduled?",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Yes, coming Thursday morning. We're down to about 20 bundles so should be fine until then.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message: "I'll make sure the storage area is cleared out for the delivery.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message:
      "Perfect. Also reminder - staff meeting tomorrow at 9am in the lodge. We're going over the holiday weekend plans.",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message: "Got it. Should I prep the reservation summary for the meeting?",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message: "That would be great, thanks Mike! Include the VIP guests list too.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message:
      "I'll have the maintenance report ready. Just finished pest control inspection on the cabins - all clear.",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Nice! Speaking of cabins, C301 guest wants extra towels. Will drop them off during rounds if that helps.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message:
      "That'd be perfect. Thanks for being proactive everyone. Let's make this a great weekend!",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message:
      "Absolutely! Oh, almost forgot - the Johnson family (site R105) asked about the s'mores kit pricing.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message:
      "S'mores kits are $12 and include marshmallows, graham crackers, and chocolate for 4 people. We also have the deluxe kit for $18.",
  },
  {
    firstName: "Bob",
    lastName: "Fixit",
    message: "Going to lunch now. Back in 45 to continue with the propane checks on the RV sites.",
  },
  {
    firstName: "Sarah",
    lastName: "Manager",
    message: "Sounds good. Mike, don't forget to eat too - it's going to be a busy afternoon!",
  },
  {
    firstName: "Mike",
    lastName: "Reception",
    message: "Ha! Already ordered from the diner. First arrivals just pulled in!",
  },
];
...
async function main() {
  ...
  for (let i = 0; i < Math.min(campground.reservations.length, guestConversations.length); i++) {
    ...
    const maxMessages = Math.max(
      conversation.guestMessages.length,
      conversation.staffReplies.length,
    );
    ...
    console.log(
      `  Created conversation with ${reservation.guest.primaryFirstName} ${reservation.guest.primaryLastName}`,
    );
  }
