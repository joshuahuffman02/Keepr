...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  // Phase 1: Foundation
  {
    ...
    description: "Basic info and location",
    phase: "foundation",
    required: true,
  },
  {
    ...
    title: "Hours & Times",
    description: "Check-in, check-out, quiet hours",
    phase: "foundation",
    required: true,
  },
  {
  ...
  // Phase 2: Inventory
  {
    ...
    title: "Your Sites",
    description: "Import or build manually",
    phase: "inventory",
    required: true,
  },
  {
  ...
  },
  {
    key: "site_classes",
    title: "Site Types",
    description: "Define accommodation types",
    phase: "inventory",
    required: false,
  },
  {
    key: "sites_builder",
    title: "Add Sites",
    description: "Create bookable inventory",
    phase: "inventory",
    required: false,
  },
  // Phase 3: Pricing
  {
    key: "rate_periods",
    title: "Rate Periods",
    description: "Define pricing seasons",
    phase: "pricing",
    required: false,
  },
  {
    key: "rates_setup",
    title: "Pricing",
    description: "Set rates per site type",
    phase: "pricing",
    required: true,
  },
  {
    key: "fees_and_addons",
    title: "Fees & Add-ons",
    description: "Booking fees and extras",
    phase: "pricing",
    required: false,
  },
  ...
  },
  {
    key: "booking_rules",
    title: "Booking Rules",
    description: "Advance booking and stay limits",
    phase: "rules",
    required: true,
  },
  {
    key: "deposit_policy",
    title: "Deposits",
    description: "Payment collection rules",
    phase: "rules",
    required: true,
  },
  {
  ...
  },
  {
    ...
    title: "Waivers",
    description: "Liability and guest agreements",
    phase: "rules",
    required: false,
  },
  {
  ...
  // Phase 6: Feature Selection
  {
    key: "menu_setup",
    title: "Sidebar Menu",
    description: "Customize your navigation",
    phase: "features",
    required: false,
  },
  {
  ...
  },
  {
    ...
    description: "Personalize your setup",
    phase: "features",
    required: false,
  },
  {
    ...
    description: "Select what to set up",
    phase: "features",
    required: false,
  },
  {
    key: "guided_setup",
    title: "Feature Setup",
    description: "Configure selected features",
    phase: "features",
    required: false,
  },
  // Phase 7: Launch
