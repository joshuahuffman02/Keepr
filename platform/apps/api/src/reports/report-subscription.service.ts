...
export class ReportSubscriptionService {
  ...
  private async generateArrivalsReport(
    campgroundId: string | null,
    startDate: Date,
    endDate: Date,
  ) {
    ...
    return {
      ...
      metrics: [
        ...
        { label: "Resolved", value: resolved.toString() },
        {
          ...
          value: avgHours === "N/A" ? avgHours : `${avgHours} hours`,
        },
      ],
    };
  }

  private async generateReservationActivityReport(
    campgroundId: string | null,
    startDate: Date,
    endDate: Date,
  ) {
  ...
  private async generateGuestActivityReport(
    campgroundId: string | null,
    startDate: Date,
    endDate: Date,
  ) {
