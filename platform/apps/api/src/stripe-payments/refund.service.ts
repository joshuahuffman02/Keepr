...
export class RefundService {
   ...
   */
  async getRefundEligibility(campgroundId: string, paymentId: string): Promise<RefundEligibility> {
  ...
  async processRefund(
    ...
    const stripeChargeId = typeof refund.charge === "string" ? refund.charge : refund.charge?.id;
