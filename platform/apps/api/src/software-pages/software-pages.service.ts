  ...
  async seedSoftwarePages(): Promise<number> {
    ...
    for (const [slug, competitor] of Object.entries(COMPETITORS)) {
      await this.upsertPage({
        ...
        title: `Camp Everyday vs ${competitor.competitorName}`,
        metaTitle: `${competitor.competitorName} Alternative | Camp Everyday vs ${competitor.competitorName}`,
        metaDescription: `Looking for a ${competitor.competitorName} alternative? Compare Camp Everyday vs ${competitor.competitorName} features, pricing, and see why campgrounds are switching.`,
        heroHeadline: `Looking for a ${competitor.competitorName} Alternative?`,
        heroSubheadline: `See how Camp Everyday compares and why campgrounds are making the switch`,
        content: competitor,
        isPublished: true,
      });
      created++;
    ...
    for (const feature of Object.values(FEATURE_PAGES)) {
      await this.upsertPage({
        ...
        pageType: "feature",
        title: feature.title,
        metaTitle: `${feature.title} | Camp Everyday`,
