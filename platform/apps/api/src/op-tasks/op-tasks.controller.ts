...
export class OpTasksController {
  ...
  async findTasks(@Param("campgroundId") campgroundId: string, @Query() query: OpTaskQueryDto) {
  ...
  async getMyTasks(@Param("campgroundId") campgroundId: string, @Req() req: ExpressRequest) {
  ...
  async updateTrigger(@Param("triggerId") triggerId: string, @Body() dto: UpdateOpTaskTriggerDto) {
  ...
  async getMyTeams(@Param("campgroundId") campgroundId: string, @Req() req: ExpressRequest) {
  ...
  async createTeam(@Param("campgroundId") campgroundId: string, @Body() dto: CreateOpTeamDto) {
    return this.teamService.create(campgroundId, dto);
  }

  @Patch(":campgroundId/teams/:teamId")
  async updateTeam(@Param("teamId") teamId: string, @Body() dto: UpdateOpTeamDto) {
  ...
  async addTeamMember(@Param("teamId") teamId: string, @Body() dto: AddTeamMemberDto) {
    return this.teamService.addMember(teamId, dto);
  }

  @Delete(":campgroundId/teams/:teamId/members/:userId")
  async removeTeamMember(@Param("teamId") teamId: string, @Param("userId") userId: string) {
  ...
  async escalateTask(@Param("taskId") taskId: string, @Body() body: { escalateToUserId: string }) {
  ...
  async getMyStats(@Param("campgroundId") campgroundId: string, @Req() req: ExpressRequest) {
