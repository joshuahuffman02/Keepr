...
**[CAMPGROUND NAME]** ("Data Controller" or "Company")
[Address]

**And:**

**[VENDOR NAME]** ("Data Processor" or "Vendor")
[Address]
...
**"Personal Data"** means any information relating to an identified or identifiable natural person, including but not limited to: names, addresses, email addresses, phone numbers, payment information, and reservation details.
...
**"Applicable Privacy Laws"** means all applicable federal, state, and local laws regarding privacy and data protection, including but not limited to CCPA, state breach notification laws, and PCI-DSS (if applicable).
...
b) Not Process Personal Data for any purpose other than providing the contracted services

c) Not sell, rent, or otherwise disclose Personal Data to third parties except as permitted in this Agreement
...
b) Limit access to Personal Data to personnel who require access to perform the services
...
d) Secure disposal of Personal Data
...
b) Ensure subprocessors are bound by equivalent data protection obligations

c) Remain fully liable for subprocessor compliance
...
b) Assist Company in responding to Data Subject requests
...
d) Take immediate steps to mitigate harm

e) Preserve evidence for investigation
...
b) Review Vendor's security certifications and audit reports
...
c) Certify in writing that all Personal Data has been returned or deleted

d) Delete Personal Data from backup systems within 90 days
...
b) Vendor's violation of Applicable Privacy Laws
