...
var PrismaService = class _PrismaService extends import_client.PrismaClient {
  ...
  constructor() {
    ...
    if (!connectionString) {
      throw new import_common.InternalServerErrorException("DATABASE_URL or PLATFORM_DATABASE_URL must be set");
    }
...
var OAuth2Service = class _OAuth2Service {
  ...
  */
  async issueClientCredentialsToken(opts) {
    ...
    const grantedScopes = requestedScopes.length > 0 ? validateScopes(requestedScopes, allowedScopes) : allowedScopes;
  ...
  */
  async refreshAccessToken(refreshToken) {
    ...
    const tokens = await this.generateTokens(token.oAuthClientId, token.oAuthClient.campgroundId, scopes, token.userId || void 0);
  ...
  */
  async registerClient(opts) {
    ...
    const scopes = opts.scopes && opts.scopes.length > 0 ? opts.scopes : DEFAULT_API_SCOPES.map((s) => s);
...
], OAuth2TokenRequestDto.prototype, "grant_type", void 0);
_ts_decorate3([
...
], OAuth2TokenRequestDto.prototype, "client_id", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "client_secret", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "scope", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "refresh_token", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "code", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "redirect_uri", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2TokenRequestDto.prototype, "code_verifier", void 0);
...
_ts_decorate3([
  ...
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "client_id", void 0);
_ts_decorate3([
  (0, import_swagger.ApiProperty)({
    enum: [
  ...
  _ts_metadata3("design:type", typeof OAuth2ResponseType === "undefined" ? Object : OAuth2ResponseType)
], OAuth2AuthorizeRequestDto.prototype, "response_type", void 0);
_ts_decorate3([
  (0, import_swagger.ApiProperty)({
  ...
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "redirect_uri", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
    description: "Space-separated list of requested scopes"
  }),
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "scope", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "state", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "code_challenge", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
    enum: [
      "S256",
  ...
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "code_challenge_method", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", String)
], OAuth2AuthorizeRequestDto.prototype, "nonce", void 0);
...
_ts_decorate3([
  ...
  (0, import_class_validator.IsNotEmpty)(),
  _ts_metadata3("design:type", String)
], OAuth2RevokeRequestDto.prototype, "token", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
    enum: [
      "access_token",
  ...
  _ts_metadata3("design:type", String)
], OAuth2RevokeRequestDto.prototype, "token_type_hint", void 0);
...
_ts_decorate3([
  ...
  (0, import_class_validator.IsNotEmpty)(),
  _ts_metadata3("design:type", String)
], OAuth2IntrospectRequestDto.prototype, "token", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
    enum: [
      "access_token",
  ...
  _ts_metadata3("design:type", String)
], OAuth2IntrospectRequestDto.prototype, "token_type_hint", void 0);
...
_ts_decorate3([
  ...
  (0, import_class_validator.IsNotEmpty)(),
  _ts_metadata3("design:type", String)
], OAuth2ClientRegistrationDto.prototype, "name", void 0);
_ts_decorate3([
  (0, import_swagger.ApiProperty)({
...
], OAuth2ClientRegistrationDto.prototype, "redirect_uris", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", Array)
], OAuth2ClientRegistrationDto.prototype, "scopes", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
  ...
  (0, import_class_validator.IsOptional)(),
  _ts_metadata3("design:type", Array)
], OAuth2ClientRegistrationDto.prototype, "grant_types", void 0);
_ts_decorate3([
  (0, import_swagger.ApiPropertyOptional)({
...
], OAuth2ClientRegistrationDto.prototype, "is_confidential", void 0);
  ...
  */
  async authorize(query, user, res) {
    if (query.response_type !== OAuth2ResponseType.CODE) {
      return this.redirectWithError(res, query.redirect_uri, "unsupported_response_type", "Only 'code' response type is supported", query.state);
    }
    try {
...
_ts_decorate5([
  ...
  _ts_metadata4("design:returntype", Promise)
], OAuth2Controller.prototype, "revoke", null);
_ts_decorate5([
  ...
  _ts_metadata4("design:returntype", Promise)
], OAuth2Controller.prototype, "introspect", null);
_ts_decorate5([
...
], OAuth2Controller.prototype, "getOpenIdConfiguration", null);
